...
export default function TokenSidebar() {
  ...
  return (
    <div className="relative 
                ...
                p-6 text-white
                backdrop-blur-md bg-gradient-to-l from-[rgba(108,92,231,0.4)] to-[rgba(164, 103, 255, 0.59)
                backdrop-blur-2xl
      ...
      <div className="my-4 text-center">
        <button className="bg-blue-400/10 
         font-sans
         font-semibold 
        relative 
        right-43  
      ...
      <div className="space-y-3">
        {tokens.map((token, index) => (
          <div
            key={index}
            className="flex items-center justify-between px-4 py-2 rounded bg-white/10 hover:bg-white/20  transition-all"
          >
